...
Object.assign(AppUsersApi.prototype, {
     ...
     * @return {APIResponse}
     */
    trackEvent: (0, _smoochMethod2.default)({
        params: ['userId', 'eventName', 'props'],
        optional: ['props'],
        path: '/appusers/:userId/events',
        func: function trackEvent(url, userId, eventName) {
     ...
     * @return {APIResponse}
     */
    updatePushToken: (0, _smoochMethod2.default)({
    ...
    */
    updateDevice: (0, _smoochMethod2.default)({
